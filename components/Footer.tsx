...
export default function Footer() {
  return (
    // <>
    <div className="w-full  relative font-sfregular  flex flex-col gap-12 p-12 md:p-24 items-center justify-center bg-zinc-900">
      ...
      <div className="flex flex-col gap-6 ">
        <div className="flex mt-12  md:flex-row flex-col justify-between items-center gap-6 ">
          <div>
            <Link
              href={'/'}
              className="italic md:mr-12 font-serif text-5xl text-white"
            >
              Chrysalis
            </Link>
          </div>
          <div className="footer-links font-sfregular ">
            <Link
              href={'/about'}
          ...
          <div className="flex flex-row space-x-8 items-center justify-between">
            <a target="_blank" href={`mailto:${Links[0].mail}`} className='opacity-50 hover:opacity-100'>
              <Mail color="#ffffff" size={15} />
            </a>
            <a target="_blank" href={Links[0].insta} className='opacity-50 hover:opacity-100'>
              <svg
                width="12"
                height="13"
                viewBox="0 0 12 13"
            ...
            <a target="_blank" href={Links[0].yt} className='opacity-50 hover:opacity-100'>
              <svg
                width="13"
                height="9"
                viewBox="0 0 13 9"
...
const Newsletter = () => {
  return (
    <div className="w-full">
      <h2 className="font-sfbold text-3xl font-bold text-white sm:text-4xl ">
        Subscribe to our newsletter.
      </h2>
      <p className="mt-4 text-lg  text-gray-400">
        You can subscribe to our newsletter to get the latest updates and blogs
      ...
      <div className="mt-6 flex max-w-md gap-x-4">
        ...
        <input
          ...
          type="email"
          required
          className=" min-w-0 opacity-50 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-lg ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
        ...
        <button
          type="submit"
          disabled
          className="opacity-50 cursor-not-allowed flex-none rounded-md bg-blue-500 px-3.5 py-2.5 text-sm  text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-gradient-to-b from-blue-500 to-blue-600"
        >
          Subscribe
        </button>
      </div>
  ...
  return (
    <div className=" w-full  text-white flex flex-col">
      <div className="w-full text-4xl font-bold">
        <h1 className="w-full font-bold font-sfbold">Contribute to us.</h1>
      </div>
      <div className="flex mt-4 flex-col gap-7  md:justify-between">
        <p className="w-full md:w-2/3 text-gray-400">
          You can contribute to this project. Contact us through email or
          whatsapp.
        </p>
        <div className="w-32 md:pt-0">
          <a
            href="/contact"
            className="bg-gradient-to-b from-blue-500 to-blue-600 hover:opacity-80 justify-center text-center rounded-lg shadow px-1.5 py-3 text-sm flex items-center"
          >
            Contact Us
          </a>
        </div>
